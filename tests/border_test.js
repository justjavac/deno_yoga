...
Deno.test("border_no_size", function () {
...
Deno.test("border_container_match_child", function () {
  var config = Yoga.Config.create();
...
Deno.test("border_flex_child", function () {
  var config = Yoga.Config.create();
...
Deno.test("border_stretch_child", function () {
  var config = Yoga.Config.create();
...
Deno.test("border_center_child", function () {
  var config = Yoga.Config.create();
